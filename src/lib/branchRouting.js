...
//   4. Mirror every change into functions/branchRouting.js (identical except
 ...
 */
export function nearestBranchForZip(zip, availableBranches = null) {
  if (!zip) return null;
